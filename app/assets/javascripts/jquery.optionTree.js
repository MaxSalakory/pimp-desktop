...
$.fn.optionTree = function(tree, options) {
    ...
    options = $.extend({
        choose: 'Kies...', 			// string with text or function that will be passed current level and returns a string
        show_multiple: 9, 			// show multiple values (if true takes number of items as size, or number (eg. 12) to show fixed size)
        preselect: {},
